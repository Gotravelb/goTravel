...
const Forms = () => {
  ...
  const FormTabs = [
    {
      ...
      key: "1",
      description:
        "we value safety, diversity in people and ideas, and having a team made up of those that have a passion for excellence.",
    },
    {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center bg-none bg-cover bg-no-repeat relative overflow-hidden">
      ...
      <div className="flex flex-col items-center w-full max-w-[496px] m-6 px-2 rounded-lg bg-white">
        <h2 className="text-center font-bold text-gray-700 w-full text-3xl pt-6">
          Book your luxury Sedan/Suv
        </h2>
