...
const BasicForm = ({ selectedTab }) => {
  ...
  const handleInputChange = (fieldName, inputValue) => {
    ...
    switch (fieldName) {
      case "name":
        errors.name =
          inputValue.length < 3 ? "Minimum 3 characters required" : "";
        break;
      case "phoneNo":
        const phoneRegex = /^[0-9]{10}$/;
        errors.phoneNo = !phoneRegex.test(inputValue)
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col">
          ...
          <div className="mb-4 text-base flex justify-between">
            <div className="w-1/2 mr-2">
              ...
              <MapAutocompleteInput
                ...
                name="pickup"
                placeholder={
                  selectedOption === "pickup from airport"
                    ? formData.pickup
                    : "Enter a location"
                }
            ...
            <div className="w-1/2 ml-2">
              ...
              <MapAutocompleteInput
                ...
                name="drop"
                placeholder={
                  selectedOption === "drop to airport"
                    ? formData.drop
                    : "Enter a location"
                }
                onPlaceChange={handlePlaceChange}
          ...
          <div className="flex justify-center items-center mt-4 flex-col">
            <button
              type="submit"
              // className="w-1/2 bg-[#70e772] py-2 rounded-lg text-base hover:bg-[#45c747]"
              className={`bg-${submitted ? 'yellow' : 'green'}-900 hover:bg-${submitted ? 'yellow' : 'green'}-700 bg-[#70e772] font-bold py-2 px-4 w-1/2 rounded`}
            >
